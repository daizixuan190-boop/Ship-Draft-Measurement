...
from ultralytics.nn.modules.mobilenetv4nop5 import MobileNetV4ConvSmall, MobileNetV4ConvSmall_Slim, MNV4FeatureSelect
from ultralytics.nn.modules.gab import GAB
...
# -------------------------------------------
        # ---【修改点】 ---
        elif m in (MobileNetV4ConvSmall, MobileNetV4ConvSmall_Slim):
            args = []
            _dummy = m()
            c2 = _dummy.channel
        elif m is MNV4FeatureSelect:
            c2 = ch[f][args[0]]
        # ---【修改点】 ---
        elif m is AIFI:
            args = [ch[f], *args]
